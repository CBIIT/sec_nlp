...
create table candidate_criteria (
    ...
    candidate_criteria_text text candidate_criteria_norm_form text,
...
--     n.pref_name,
--     n.span_text,
--     n.inclusion_indicator,
--     n.description
-- from
--     nlp_data_view n
--     join performance_statuses ps on n.ncit_code = ps.descendant
...
-- from
--     nlp_data_view n
--     join codes_of_interest ps on n.ncit_code = ps.descendant
--     /* gene or biomarker */
--     with codes_of_interest as (
--         select
--             descendant
...
--             ncit_tc
--         where
--             parent in('C16612', 'C16342', 'C18093', 'C45576')
--     );
